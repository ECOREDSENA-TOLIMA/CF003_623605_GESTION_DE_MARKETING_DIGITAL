...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="En la síntesis el consumidor digital y modelos de negocio muestra las dinámicas del consumidor digital y se examinan plataformas digitales clave, como tiendas virtuales, redes sociales, sitios web entre otras.")
      .col-auto
